...
const fragmentShader=`
 ...
 void main(){
  ...
  vec3 color=mix(vec3(.009,.105,.255),vec3(.025,.38,.51),shallow);
  color=mix(color,vec3(.035,.49,.54),lagoon*.68);
  color*=.78+diffuse*.25;
  color=mix(color,vec3(.14,.38,.53),fresnel*.26);
...
const bedFragment=`
 ...
 void main(){
  ...
  vec3 floorColor=mix(vec3(.012,.105,.21),vec3(.48,.62,.49),sand);
  floorColor=mix(floorColor,vec3(.16,.39,.43),shoreData.g*.66);
